  ...
  return (
    <>
      ...
      <View style={styles.bestTimesSection}>
        <Text style={styles.bestTimesTitle}>Καλύτερες Ώρες</Text>
      ...
      <View style={styles.sunMoonSection}>
        <View style={styles.sunMoonRow}>
          <View style={styles.sunMoonItem}>
            ...
            <Text style={styles.sunMoonText}>Ανατολή: {info.sunriseLabel}</Text>
          </View>
          <View style={styles.sunMoonItem}>
            <Sun size={18} color={colors.white} strokeWidth={2.5} />
            <Text style={styles.sunMoonText}>Δύση: {info.sunsetLabel}</Text>
          </View>
        </View>
